...
**MVP**: Natural-language → SQL or metric answer using schema + KPI definitions + known data caveats.

| Milestone | Deliverable |
|-----------|-------------|
| 1. Context pack | Schema docs, metric glossary, known data-quality notes |
| 2. SQL path | Generate + (optionally) dry-run SQL against sample DB |
| 3. Definition grounding | Disambiguate conflicting “revenue”/ARR definitions |
| 4. Answer framing | Always state data-as-of date and caveats |

**Done when**: 15 BI questions answered with correct metric definitions; wrong SQL caught by validation or explanation.
**Estimate**: 2 weeks · **Target finish**: Sep 17, 2026
