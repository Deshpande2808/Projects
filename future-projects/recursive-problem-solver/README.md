...
**MVP**: Open-ended goal → decompose → solve subtasks → integrate → re-plan when verification fails (e.g. trading-strategy or coding challenge).

| Milestone | Deliverable |
|-----------|-------------|
| 1. Decomposer | Goal → subtask tree with dependencies |
| 2. Solve + integrate | Subtask results composed into whole |
| 3. Adaptive replan | Failed subtask → new decomposition |
| 4. Demo domain | One end-to-end goal with clear success metric |

**Done when**: Agent recovers from at least one failed plan via re-decomposition; final output meets the stated metric.
**Estimate**: 2.5 weeks · **Target finish**: Feb 16, 2027
