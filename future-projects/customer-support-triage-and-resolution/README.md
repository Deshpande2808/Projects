...
**MVP**: Ticket graph: Intake → FAQ/Billing/Tech/Product specialists → Feedback; escalate to human when unresolved.

| Milestone | Deliverable |
|-----------|-------------|
| 1. Router graph | Intake classification + edges to specialists |
| 2. Specialist loops | Each node has observe–act–verify stop conditions |
| 3. Escalation path | Unresolved → EscalationAgent with case brief |
| 4. Feedback | Resolutions feed FAQ improvements (even if manual) |

**Done when**: End-to-end ticket simulation routes correctly; simple FAQs resolve without human; hard cases escalate with context.
**Estimate**: 3 weeks · **Target finish**: Mar 9, 2027
