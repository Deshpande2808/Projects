...
**MVP**: Product Q&A with citations to docs + plan-aware answers (what the customer can access).

| Milestone | Deliverable |
|-----------|-------------|
| 1. Corpus | Versioned API docs, pricing, FAQ, changelog as indexed sources |
| 2. Metadata filters | Plan tier / feature flags in retrieval |
| 3. Citations | Every claim links to source chunk + doc version |
| 4. Anti-hallucination | Refuse pricing/features not in corpus |

**Done when**: Zero invented pricing on a 30-question eval; every answer has ≥1 citation.
**Estimate**: 1.5 weeks · **Target finish**: Sep 3, 2026
